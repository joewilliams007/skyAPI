module.exports = (req, res) => {
    ...
    function checkCount() {
        db.query(
            `SELECT COUNT(*) AS RowCount FROM Reaction WHERE user_id = ${user_id} AND emoji = ${reaction} AND post_id = ${post_id}`
    ...
    function deleteReaction() {
        db.query(
            ...
            WHERE user_id = ${user_id} AND emoji = ${reaction} AND post_id = ${post_id}`
            , function (error, results, fields) {
                if (error) {
    ...
    function setReaction() {
        db.query(
            `INSERT INTO Reaction (user_id, post_id, emoji, timestamp) 
